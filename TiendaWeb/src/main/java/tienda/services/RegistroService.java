...
public class RegistroService {
    ...
    public Model recordarUsuario(Model model, Usuario usuario)
        ...
        String mensaje;
        Optional<Usuario> usuarioOpt = usuarioService.getUsuarioPorUsernameOCorreo(usuario.getUsername(),
                usuario.getCorreo());
    ...
    private void enviaCorreoActivar(Usuario usuario, String clave) throws MessagingException {
        ...
        mensaje = String.format(mensaje, usuario.getNombre(), usuario.getApellidos(), servidor, usuario.getUsername(),
                clave);
