...
public class UsuarioService {
    ...
    public void save(Usuario usuario, MultipartFile imagenFile, boolean encriptaClave) {
        ...
        if (usuarioDuplicado.isPresent()) {
            ...
            // Verifica si estamos en modo CREACIÓN (idUser == null) O si el ID encontrado
            // NO es el mismo que estamos actualizando
        ...
        // Se valida si la clave se va actualizar o si es un usuario nuevo se debe
        // actualizar...
        ...
        if (usuario.getIdUsuario() == null) {
            ...
            if (usuario.getPassword() == null || usuario.getPassword().isBlank()) {
                ...
                usuario.setPassword(encriptaClave ? passwordEncoder.encode(usuarioExistente.getPassword())
